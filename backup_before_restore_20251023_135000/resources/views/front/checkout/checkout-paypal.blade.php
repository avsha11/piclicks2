@if(env('PAYPAL_CLIENT_ID') && env('PAYPAL_CLIENT_ID') !== 'DEMO')
...
@else
<script>
    // PayPal not configured - show message instead of button
        ...
        if (paypalContainer) {
            paypalContainer.innerHTML = `
                <div class="alert alert-warning">
                    ...
                    PayPal payment is not configured. Please contact support or use alternative payment methods.
                </div>
            `;
        }
    });
