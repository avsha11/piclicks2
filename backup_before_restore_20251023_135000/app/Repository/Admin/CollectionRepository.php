...

{
...

    {
        ...
        try {
            ...
            Log::error("Error in CollectionRepository.create(): " . $e->getMessage());
...

    {
        ...
        try {
            ...
            Log::error("Error in CollectionRepository.getUser(): " . $e->getMessage());
...

    {
        ...
        try {
            ...
            Log::error("Error in CollectionRepository.userList(): " . $e->getMessage());
...

    {
        ...
        try {
            ...
            Log::error("Error in CollectionRepository.deleteData(): " . $e->getMessage());
...

    {
        ...
        try {
            ...
            Log::error("Error in CollectionRepository.getUsersByWhere(): " . $e->getMessage());
