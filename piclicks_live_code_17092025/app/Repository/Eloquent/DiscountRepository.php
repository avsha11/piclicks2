...

{
...

    {
        ...
        try {
            ...
            Log::error("Error in DiscountRepository.create(): " . $e->getMessage());
...

    {
        ...
        try {
            ...
            Log::error("Error in DiscountRepository.getUser(): " . $e->getMessage());
...

    {
        ...
        try {
            ...
            return $this->model->with('priceManagement')->orderBy('id', 'desc')->get();

        } catch (\Exception $e) {

            Log::error("Error in DiscountRepository.userList(): " . $e->getMessage());
...

    {
        ...
        try {
            ...
            Log::error("Error in DiscountRepository.deleteData(): " . $e->getMessage());
...

    {
        ...
        try {
            ...
            Log::error("Error in DiscountRepository.getUsersByWhere(): " . $e->getMessage());
