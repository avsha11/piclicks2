...
@section('content')
    <style>
        ...
        /* Align carousel container to left without white gap */
        body {
        ...
        /* Target the preview section specifically - ensure no padding/margin */
        body > section,
        ...
        /* Ensure header doesn't push content */
        .header_area {
            position: relative;
            z-index: 1;
        }

        /* Override Bootstrap container-fluid default padding (15px) */
        .container-fluid {
            padding-left: 0 !important;
            padding-right: 0 !important;
            margin-left: 0 !important;
        ...
        /* Override Bootstrap row negative margins and gutters */
        .row {
            margin-left: 0 !important;
            margin-right: 0 !important;
        ...
        /* Remove padding from all row children (Bootstrap columns) */
        .row > * {
            padding-left: 0 !important;
            padding-right: 0 !important;
        }

        /* Specifically target the carousel column */
        .col-lg-7.col-xl-8 {
            padding-left: 0 !important;
            padding-right: 0 !important;
            margin-left: 0 !important;
        ...
        /* Carousel images - ensure they align to left edge */
        .carousel-item img {
            margin-left: 0 !important;
            padding-left: 0 !important;
            display: block;
        ...
        /* Ensure collage-container doesn't add spacing */
        #collage-container {
            margin-left: 0 !important;
            padding-left: 0 !important;
        }
