                                        ...
                                        @foreach ($order->orderdetail_data as $key => $orderData)
                                            @if ($orderData->name == 'collage' || $orderData->name == 'artgallery')
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            // Use preview_image_path (generated by PreviewRenderer) if available, otherwise fallback to image_path
                                                            $thumbnailPath = $orderData->preview_image_path ?? ($orderData->design_collage_master->image_path ?? null);
                                                            $thumbnailUrl = $thumbnailPath ? asset('storage/' . $thumbnailPath) : asset('assets/images/collage-image.png');
                                                        @endphp
