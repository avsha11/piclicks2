        ...
        CanvasRenderer.prototype.renderReplacedElement = function (container, curves, image) {
            ...
            if (image && container.intrinsicWidth > 0 && container.intrinsicHeight > 0) {
                ...
                if (objectFit === 'contain' || objectFit === 'cover') {
                    ...
                    // this.ctx.drawImage(image, 0, 0, container.intrinsicWidth, container.intrinsicHeight, newX + x, newY + y, newWidth, newHeight); // commented because this line is working for position: top left
                } else {
                    this.ctx.drawImage(image, 0, 0, container.intrinsicWidth, container.intrinsicHeight, box.left, box.top, box.width, box.height);
                }
