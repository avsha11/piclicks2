...
class TransactionRepository
{
    ...
    public function create($allData)
    {
        try {
            ...
            Log::error("Error in TransactionRepository.create(): " . $e->getMessage());
            throw $e;
    ...
    public function getOne($byWhere)
    {
        try {
            ...
            Log::error("Error in TransactionRepository.getUser(): " . $e->getMessage());
            return response()->json(['status' => '0', 'message' => __('message.statusZero')]);
        }
    }
    ...
    public function getAll()
    {
        try {
            ...
            Log::error("Error in TransactionRepository.userList(): " . $e->getMessage());
            return response()->json(['status' => '0', 'message' => __('message.statusZero')]);
        }
    }
    ...
    public function delete($byWhere)
    {
        try {
            ...
            Log::error("Error in TransactionRepository.deleteData(): " . $e->getMessage());
            throw $e;
            // return response()->json(['status' => '0', 'message' => __('message.statusZero')]);
        }
    }
    ...
    public function getByWhere($byWhere, $orderBy = ['id' => 'asc'])
    {
        try {
            ...
            Log::error("Error in TransactionRepository.getUsersByWhere(): " . $e->getMessage());
            return response()->json(['status' => '0', 'message' => __('message.statusZero')]);
        }
    }
